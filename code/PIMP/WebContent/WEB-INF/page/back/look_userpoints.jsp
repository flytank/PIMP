...
<div id="modal-table-change" class="modal fade text-center" tabindex="-1" data-backdrop="static">
	<div class="modal-dialog" style="display: inline-block; width: 80%;margin-left:auto;margin-right: auto;">
			<div class="modal-content" >
				...
				<div class="modal-body" style="overflow-y: scroll;">
					<div id="modal-tip" class="red clearfix"></div>
					<input id="jcId" type="hidden" />
					<input id="mbMapList" type="hidden"/>
					<input id="sxLength" type="hidden"/>
					<div class="widget-box widget-color-blue2">
						<div class="widget-body">
							<div class="widget-main padding-8">
        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/userpoints/getLookParty",
        			datatype : "json",
        			height : 450,
        			...
        			*/
        			gridComplete : function(){
        				...
        				for(var i = 0; i < ids.length; i++){
        					...
        					look = "<a href='#page/look_userpoints' title='查看' onclick='LookData(\"" + id + "\")'>查看</a>";		
				...
				/* jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/look_userpoints/operateSysUser?oper=excel' method='post'>";
