...
<html lang="zh-cn">
    <head>
        ...
        <link rel="stylesheet" href="${contextPath}/static/assets/css/altmm.css"/>
        <!--[if lte IE 9]>
    ...
    <body class="no-skin">
            ...
            <div class="navbar-container" id="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    ...
                    <a href="#" class="navbar-brand">
                        <small>
                            <i class="fa fa-leaf"></i>栾城区党员积分管理系统
                        </small>
                    </a>
                    <!-- /section:basics/navbar.layout.brand -->
        ...
        <!-- custom scripts -->
		<script src="${contextPath}/static/assets/js/custom/common.js"></script>
        <!-- ace scripts -->
        ...
        <script src="${contextPath}/static/assets/js/custom/app.js"></script>
        <script src="${contextPath}/static/assets/js/jquery.validate.js"></script>
        <script src="${contextPath}/static/assets/js/messages_zh.js"></script>
    </body>
</html>
