...
<script type="text/javascript">
	$(function(){
		...
		$("#query").on("click", function() {
			...
			//党员信息
			jsonData += "{'field' : 'identity', 'op' : 'eq', 'data' : '2'}";
		...
		$("#reset").on("click", function() {
			...
			$("#queryIDCard").val("");
			//党员信息
			var jsonData = "{'rules':[{'field' : 'identity', 'op' : 'eq', 'data' : '2'}], 'groupOp':'AND'}";
			$("#grid-table").jqGrid('setGridParam',{
		        datatype:'json',
		        postData:{'filters':jsonData}, //发送数据
		        page:1
					...
					<div class="widget-box widget-color-blue2">
						<div class="widget-body">
							<div class="widget-main padding-8">
							  <form id="validationAddActivistForm" method="post" action="#">
...
<script type="text/javascript">
		...
		$("#submitButton").bind("click", function() {
			$('#validationAddActivistForm').submit();
		});
// 		冶河镇端固庄村001党小组
...
// 			}, "此登录名不唯一！");
		...
		$('#validationAddActivistForm').validate({
			errorElement : 'span',
        			...
        			gridComplete : function(){
        				...
        				for(var i = 0; i < ids.length; i++){
        					...
        					if(role == 'ROLE_ADMIN' || role == 'zone'){//超级管理员&&区域管理员
            					...
            					look = "<a href='#page/activist' onclick='LookData(\"" + id + "\")'>修改</a>&nbsp;&nbsp;&nbsp;"
            						+"<a href='#page/activist' onclick='resetPassword(\"" + id + "\")'>重置密码</a>";	
