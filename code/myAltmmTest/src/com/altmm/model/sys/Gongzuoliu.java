...
import com.altmm.model.sys.param.GongzuoliuParameter;
...
public class Gongzuoliu extends GongzuoliuParameter {
	...
	public boolean equals(Object obj) {
		...
		return Objects.equal(this.id, other.id)
				&& Objects.equal(this.dictKey, other.dictKey)
				&& Objects.equal(this.dictValue, other.dictValue)
				&& Objects.equal(this.sequence, other.sequence)
				&& Objects.equal(this.parentDictkey, other.parentDictkey);
	}

	public int hashCode() {
		return Objects.hashCode(this.id, this.dictKey, this.dictValue,
				this.sequence, this.parentDictkey);
	}
