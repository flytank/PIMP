...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="row">
			<div class="col-xs-12">
				<h3 class="header smaller lighter green">应用程序按钮</h3>
		...
		<div class="row">
			<div class="col-sm-6" id="default-buttons">
				<h3 class="row header smaller lighter purple">
					<span class="col-sm-6"> 默认按钮 </span><!-- /.col -->
				...
				<!-- /section:elements.button.white -->
				<h3 class="header smaller lighter green">带图标的按钮</h3>
			...
			<div class="col-sm-6">
				...
				<h3 class="header smaller lighter grey">不可用按钮</h3>
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<h3 class="header smaller lighter green">带下拉列表的按钮</h3>
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<h3 class="header smaller lighter red">分页</h3>
