        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/sys/bqxx/getBqxx",
        			datatype : "json",
        			height : 450,
        			colNames : ['', 'ID', '病区名称', '病区类型', 'CZDRCF', 'DYTZYZ','ZDCFYZ','ZDCFSJ'],
        			colModel : [ {
        				name : '',
        				index : '',
        				width : 80,
        				...
        				editable : true,
        				sorttype : "long",
        				editoptions : {size : "20", maxlength : "1"},
        				search : false,
        			...
        			editurl : "${contextPath}/sys/bqxx/operateBqxx"
        			//caption : "用户管理列表",
        			//autowidth : true,
        			/**
        			grouping : true, 
				...
				jQuery(grid_selector).jqGrid('navButtonAdd', pager_selector,{
			       ...
			       onClickButton : function () { 
			    	   ...
			    	   var form = "<form name='csvexportform' action='${contextPath}/sys/bqxx/operateBqxx?oper=excel' method='post'>";
